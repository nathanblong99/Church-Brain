...
def _plan_with_llm(text: str, tenant_id: str, actor_id: str, existing_request_id: str | None) -> Dict[str, Any]:
    prompt = (
...
def plan(tenant_id: str, actor_id: str, text: str, existing_request_id: str | None = None) -> Dict[str, Any]:
    raw_plan = _plan_with_llm(text, tenant_id, actor_id, existing_request_id)
